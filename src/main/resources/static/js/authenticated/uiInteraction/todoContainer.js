export const createTodoContainer = async (todos) => {
    ...
    if(window.location.pathname !== '/about-us' && window.location.pathname !== '/contact-us'){
        ...
        unorderedList.classList.add('grid','xl:grid-cols-3','md:gap-x-2','lg:gap-x-4','gap-y-4','py-4','md:grid-cols-2','xs:justify-items-center','xs:h-80vh','lg:h-70vh','overflow-y-scroll');
