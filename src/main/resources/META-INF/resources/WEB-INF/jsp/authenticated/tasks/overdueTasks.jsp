...
<head>
    ...
    <title>P E A | Overdue Tasks </title>
...
<body>
                ...
                <c:choose>
                    ...
                    <div id="title">
                        ...
                        <div id="todo-lists-container">
                            <c:forEach items="${overDueTask}" var="todo">
        ...
        <div id="right-container" class="containers dim">
            ...
            <div id="date-and-time-progress-display-container">
                <div class="date-and-time">
                    <p id="date">September 11, 2001</p>
                    <p id="time">09:11:01 AM</p>
                </div>
    ...
    <script src="${pageContext.request.contextPath}/js/authenticated/sorting/todayTasks.js"></script>
