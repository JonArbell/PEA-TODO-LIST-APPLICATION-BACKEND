...
<body>
            ...
            <div id="tasks-display-container">
                ...
                <c:choose>
                    <c:when test="${empty allTasks}">
                        <h1 class="empty">No tasks available at the moment. Add some tasks to get started!</h1>
                    ...
                    <c:otherwise>
                        ...
                        <div id="todo-lists-container">
                            ...
                            <c:forEach items="${allTasks}" var="todo">
    ...
    <script src="${pageContext.request.contextPath}/js/authenticated/sorting/allTasks.js"></script>
