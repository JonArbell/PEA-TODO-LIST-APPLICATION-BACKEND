...
<head>
    ...
    <title>P E A | Completed Tasks </title>
...
<body>
    <!-- <button type="button" onclick="panis()">Panis</button> -->
            ...
            <div id="tasks-display-container">
                ...
                <c:choose>
                    <c:when test="${empty completedTasks}">
                        <h1 class="empty">Looks like you haven't completed any tasks yet. Check back later!</h1>
                    ...
                    <c:otherwise>
                        ...
                        <div id="todo-lists-container">
                            ...
                            <c:forEach items="${completedTasks}" var="todo">
    ...
    <div id="add-edit-list-container">
        ...
        <form:form modelAttribute="list" method="post">
            ...
            <div id="list-input-container">
                ...
                <form:input id="list-name" path="listName" maxlength="35" required="required" autofocus="autofocus" type="text" placeholder="List name"/>
    ...
    <script src="${pageContext.request.contextPath}/js/authenticated/sorting/completedTasks.js"></script>
